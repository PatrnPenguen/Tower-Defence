...
public class Turret : MonoBehaviour
{
    ...
    private float baseBulletPerSecond;
    ...
    private void Start()
    {
        ...
        baseBulletPerSecond = bulletsPerSecond;
    ...
    public void Upgrade()
    {
        ...
        bulletsPerSecond = CalculateBulletPerSecond();
    }
    ...
    {
        return baseBulletPerSecond * Mathf.Pow(level, 0.6f);
    }
